...
class bulk_good:
    ...
    def __init__(self,max_steps,max_episodes):
        ...
        self.Silo_Filllevel_1 = randrange(0,20) # Initialization of Silo-1
        self.Silo_Filllevel_2 = randrange(0,20)# Initialization of Silo-2
        self.Silo_Filllevel_3 = randrange(0,20)# Initialization of Silo-3
        
        self.Hopper_Filllevel_1 = randrange(0,10)   #Iniitialization of Hopper-1
        self.Hopper_Filllevel_2 = randrange(0,10)  #Initialization of Hopper-2
        self.Hopper_Filllevel_3 = randrange(0,10)  #Initialization of Hopper-3
        ...
        self.Total_Reward_3 = 0
        self.Total_Reward_4 = 0
        self.Total_Reward_5 = 0
        self.Total_Reward_6 = 0
        self.dem = 0
    ...
    def initial_state(self):
        ...
        self.Demand = uniform(10,50)
        
        return self.Silo_Filllevel_1,self.Silo_Filllevel_2,self.Silo_Filllevel_3,self.Hopper_Filllevel_1,self.Hopper_Filllevel_2,self.Hopper_Filllevel_3,self.VP_Prev_2,self.VP_Prev_3,self.VP_Prev_4,self.Rising_2,self.Falling_2,self.Rising_3,self.Falling_3,self.Rising_4,self.Falling_4,self.Q_Flip_2,self.Q_Flip_3,self.Q_Flip_4,self.Q_Flip_Prev_2,self.Q_Flip_Prev_3,self.Q_Flio_Prev_4,self.Saturator_2,self.Saturator_3,self.Saturator_4,self.Demand,self.MF_VC_2,self.MF_VC_3,self.MF_VC_4
...
######################################### BULK GOOD SYSTEM #####################################
    ...
    def environment_bgs(self,steps_in_episode,ep):
        ...
        while bigloop <=100:  # 10 secs
            ...
            f_sfl_1 = lambda x: (self.MF_VC_4-self.MF_S_H_1)
            ...
            #print("Silo_2:",self.Silo_Filllevel_1)
            # Silo Empty
            ...
            if self.Saturator_2 >= 4.575:
                self.Saturator_2 = 4.575
            ...
            #print("Hopper_Fill_2",self.Hopper_Filllevel_2,"Hopper_empty_2",self.Hopper_Empty_2)
            ...
            if self.Saturator_3 >= 9.5:
                self.Saturator_3 = 9.5
            ...
            if self.Saturator_4 >= 4.575:
                self.Saturator_4 = 4.575
        ...
        #print("T_E:",self.Total_Energy_Sim,"steps:",self.steps)
        #self.Energy_Previous = self.Total_Energy_Sim
        #print("diff",self.Total_Energy_Sim-self.Energy_Previous)
        #time.sleep(1)
        ############ Rewards ###########    
        #### Terminal State ####
        ...
        if self.steps%300== 0 and self.steps != 0 and self.steps == 300:
            if (self.Exchanged_Mass_Sim-(2500*0.3))>0:
                self.reward_1 = 5
                self.reward_2 = 5
                self.reward_3 = 5
                self.reward_4 = 5
            ...
            #print("Mass",self.Exchanged_Mass_Sim,"diff:",(self.Exchanged_Mass_Sim-(2500*0.3)),"steps:",self.steps,"reward",self.reward_1)
        ...
        if self.steps%300 == 0 and self.steps != 0 and self.steps > 300:
            if (self.Exchanged_Mass_Sim-self.mass_steps_1)>0:
                ...
                self.reward_6 = -5
            self.mass_steps_1 = self.Exchanged_Mass_Sim
            #print("Mass",self.Exchanged_Mass_Sim,"diff:",self.Exchanged_Mass_Sim-self.mass_steps_1,"steps:",self.steps,"reward",self.reward_1)   
    
            
        if self.steps%300 == 0 and self.steps != 0 and self.steps>300:
                if (self.Total_Energy_Sim_Prev-self.Total_Energy_Sim) < self.Total_Energy_Sim_Prev:
                    self.reward_1 = 5
                    self.reward_2 = 5
                    self.reward_3 = 5
                    self.reward_4 = 5
        ...
        if self.steps%300==0:
            self.Total_Energy_Sim_Prev = self.Total_Energy_Sim
                
                #print("Energy",self.Total_Energy_Sim,"diff:",self.Total_Energy_Sim-self.Total_Energy_Sim_Prev,"steps:",self.steps,"reward",self.reward_1)   
        ...
        if self.episodes%500 == 0 and self.episodes != 0:
            #print("M:",self.Mass_episodic,"E:",self.episodes)
            if self.Mass_episodic == 1250000:
                self.reward_1 = 50
                self.reward_2 = 50
                self.reward_3 = 50
                self.reward_4 = 50
        ...
        self.Total_Reward_1 = self.Total_Reward_1 + self.reward_1
        self.Total_Reward_2 = self.Total_Reward_2 + self.reward_2
        self.Total_Reward_3 = self.Total_Reward_3 + self.reward_3
        self.Total_Reward_4 = self.Total_Reward_4 + self.reward_4
        self.Total_Reward_5 = self.Total_Reward_5 + self.reward_5
        self.Total_Reward_6 = self.Total_Reward_6 + self.reward_6
        return self.Silo_Filllevel_1,self.Silo_Filllevel_2,self.Silo_Filllevel_3,self.Hopper_Filllevel_1,self.Hopper_Filllevel_2,self.Hopper_Filllevel_3,self.Energy_Conveyor_Sim,self.Energy_VC_2_Sim,self.Energy_Vibration_Belt_Sim,self.Energy_VC_3_Sim,self.Energy_Rotary_Air_Lock_Sim,self.Energy_VC_4_Sim,self.Total_Energy_Sim,self.VP_2,self.VP_3,self.VP_4,self.VP_Time_2,self.VP_Time_3,self.VP_Time_4,self.MF_VC_2,self.MF_VC_3,self.MF_VC_4,self.MF_S_H_1,self.MF_S_H_2,self.MF_S_H_3,self.Silo_Empty_1,self.Hopper_Empty_1,self.Q_Flip_2,self.Q_Flip_3,self.Q_Flip_4,self.Q_Flip_Prev_2,self.Q_Flip_Prev_3,self.Q_Flip_Prev_4,self.Saturator_2,self.Saturator_3,self.Saturator_4,self.VP_Prev_2, self.VP_Prev_3,self.VP_Prev_4,self.Exchanged_Mass_Sim,self.reached,self.reward_1,self.reward_2,self.reward_3,self.reward_4,self.reward_5,self.reward_6,self.Total_Reward_1,self.Total_Reward_2,self.Total_Reward_3,self.Total_Reward_4,self.Total_Reward_5,self.Total_Reward_6,self.Demand 
...
#    6 Energy_Conveyor_Sim   #13 VP_3                         #20 MF_S_H_3     #27 Saturator_2       #34 reward_2             #41 Total_Reward_3
    ...
    def state_space_reset(self):
        ...
        return self.Exchanged_Mass_Sim,self.Total_Energy_Sim_Prev,self.Exchanged_Mass_Sim_Prev,self.Energy_Conveyor_Sim,self.Energy_VC_2_Sim,self.Energy_Vibration_Belt_Sim,self.Energy_VC_3_Sim,self.Energy_Rotary_Air_Lock_Sim,self.Energy_VC_4_Sim,self.Total_Energy_Sim,self.reached,self.Total_Reward_1,self.Total_Reward_2,self.Total_Reward_3,self.Total_Reward_4,self.Total_Reward_5,self.Total_Reward_6,self.reward_1,self.reward_2,self.reward_3,self.reward_4,self.reward_5,self.reward_6,self.Energy_Episode
